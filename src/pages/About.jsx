...
import BannerImage1 from "../assets/Images/aboutus5.jpg";
import BannerImage2 from "../assets/Images/aboutus4.jpg";
import BannerImage3 from "../assets/Images/aboutus6.jpg";
        ...
        <div className="relative mx-auto flex w-11/12 max-w-maxContent flex-col justify-between gap-10 text-center text-white">
          <header className="mx-auto py-20 text-4xl font-semibold lg:w-[70%]">
            ...
            <p className="mx-auto mt-3 text-center text-base font-medium text-richblack-300 lg:w-[95%]">
              EduNexus is at the forefront of driving innovation in online
      ...
      <section>
        <div className="mx-auto flex w-11/12 max-w-maxContent flex-col justify-between gap-10 text-richblack-500">
          <div className="flex flex-col items-center gap-10 lg:flex-row lg:items-start lg:justify-between">
            ...
            <div className="flex lg:w-[50%] justify-center lg:justify-end">
              <img
                src={FoundingStory}
                alt="Founding Story"
                className="shadow-[0_0_20px_0] shadow-[#FC6767] w-full max-w-[500px] rounded-lg mt-28"
              />
            </div>
          </div>
